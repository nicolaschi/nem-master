                        ...
                        <div class="nk-block-head-content">
                            ...
                            <div class="nk-block-des text-soft">
                                <ul class="list-inline">
                                    <li>Unique ID: <span class="text-base">{{ Auth::User()->unique_id }}</span>
                                    </li>
                        ...
                        <div class="nk-block-head-content">
                            <a href="{{ url('/mprofile') }}"
                                class="btn btn-outline-light bg-white d-none d-sm-inline-flex"><em
                                    class="icon ni ni-arrow-left"></em><span>View Profile</span></a>
                                        ...
                                        <div class="profile-ud-list">
                                            <div class="profile-ud-item">
                                                <div class="profile-ud wider">
                                                    ...
                                                    <span
                                                        class="profile-ud-value">{{ Auth::User()->unique_id }}</span>
                                                </div>
                                            </div>
                                            <div class="profile-ud-item">
                                                <div class="profile-ud wider">
                                    ...
                                    <div class="nk-block">
                                        ...
                                        <div class="form-submit">
                                            <button type="submit" class=" btn btn-primary"
                                                onclick="payWithPaystack(event)"> Pay Certificate Fee</button>
                                        </div>
                                        </form>
