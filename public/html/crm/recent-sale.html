                                            ...
                                            <div class="toggle-wrap nk-block-tools-toggle">
                                                ...
                                                <div class="toggle-expand-content" data-content="pageMenu">
                                                    <ul class="nk-block-tools justify-between g-3">
                                                        ...
                                                        <li><a href="#" data-toggle="modal" data-target="#addSaleProduct" class="btn text-white bg-primary"><em class="icon ni ni-plus"></em><span>Add New</span></a></li>
                                                    </ul>
                                                </div>
                                            </div><!-- .toggle-wrap -->
                                        </div><!-- .nk-block-head-content -->
                                            ...
                                            <div class="card-inner p-0">
                                                <div class="nk-tb-list">
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col"><span class="badge badge-dot badge-success">Available</span></div>
                                                    </div>
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col tb-col-lg"><span class="tb-amount">$9.00</span></div>
                                                        <div class="nk-tb-col tb-col-md"><span>Mobile</span></div>
                                                        <div class="nk-tb-col"><span class="badge badge-dot badge-danger">Out of Stock</span></div>
                                                    </div>
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col tb-col-lg"><span class="tb-amount">$9.00</span></div>
                                                        <div class="nk-tb-col tb-col-md"><span>Mobile</span></div>
                                                        <div class="nk-tb-col"><span class="badge badge-dot badge-warning">Low Stock</span></div>
                                                    </div>
                                                    <div class="nk-tb-item">
                ...
                <div class="modal-body modal-body-md">
                    ...
                    <form action="#" class="mt-2">
                        <div class="row g-gs">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <button data-dismiss="modal" type="submit" class="btn btn-primary">Add Product</button>
                                </div>
                            </div>
                        </div>
                    </form>
                ...
                <div class="modal-body modal-body-md">
                    ...
                    <form action="#" class="mt-2">
                        <div class="row g-gs">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <button data-dismiss="modal" type="submit" class="btn btn-primary">Update Product</button>
                                </div>
                            </div>
                        </div>
                    </form>
                ...
                <div class="modal-body modal-body-sm text-center">
                    <div class="nk-modal py-4">
                        ...
                        <ul class="d-flex justify-content-center gx-4 mt-4">
                            <li>
                                <button data-dismiss="modal" id="deletePD" class="btn btn-success">Yes, Delete it</button>
                            </li>
                            <li>
                ...
                <div class="modal-body modal-body-md">
                    ...
                    <form action="#" class="mt-2">
                        <div class="row g-gs">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <button data-dismiss="modal" type="submit" class="btn btn-primary">Add Warehouse</button>
                                </div>
                            </div>
                        </div>
                    </form>
                ...
                <div class="modal-body modal-body-md">
                    ...
                    <form action="#" class="mt-2">
                        <div class="row g-gs">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <button data-dismiss="modal" type="submit" class="btn btn-primary">Update Warehouse</button>
                                </div>
                            </div>
                        </div>
                    </form>
                        ...
                        <div class="row g-gs">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control" id="add-price" placeholder="e.g. $999.00">
                                    </div>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control" id="add-dis" placeholder="e.g. $10.00 ">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap ">
                                        <select class="form-select" id="add-catagory">
                            ...
                            <div class="form-group">
                                <button type="submit" data-dismiss="modal" class="btn btn-primary">Add Product</button>
                            </div>
                        </div>
                    </form>
                </div>
