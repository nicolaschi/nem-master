                                                ...
                                                <div class="toggle-expand-content" data-content="pageMenu">
                                                    <ul class="nk-block-tools g-3">
                                                        ...
                                                        <li class="nk-block-tools-opt">
                                                            <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#addDeposit"><em class="icon ni ni-plus"></em>
                                                                <span>Add Deposite</span>
                                                            </a>
                                                        </li>
                                                    </ul>
                                                </div>
                                                    ...
                                                    <tbody>
                                                                ...
                                                                <ul class="nk-tb-actions gx-1">
                                                                    <li>
                                                                        <div class="drodown">
                                                                            ...
                                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                                <ul class="link-list-opt no-bdr">
                                                                                    <li><a href="#" data-toggle="modal" data-target="#editDeposit"><em class="icon ni ni-edit"></em><span>Edit </span></a></li>
                                                                                    <li><a href="#" data-toggle="modal" data-target="#deleteDeposit"><em class="icon ni ni-delete"></em><span>Delete </span></a></li>
                                                                                </ul>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                            ...
                                                            <td class="nk-tb-col">
                                                                <div class="user-card">
                                                                    <div class="user-avatar user-avatar-sm bg-warning">
                                                                        <img src="/wip/demo1/images/avatar/b-sm.jpg" alt="">
                                                                    </div>
                                                                    <div class="user-name">
                                                        ...
                                                        <tr class="nk-tb-item">
                                                            ...
                                                            <td class="nk-tb-col">
                                                                <div class="user-card">
                                                                    <div class="user-avatar user-avatar-sm bg-purple">
                                                                        <img src="/wip/demo1/images/avatar/a-sm.jpg" alt="">
                                                                    </div>
                                                                    <div class="user-name">
                                                        ...
                                                        <tr class="nk-tb-item">
                                                            ...
                                                            <td class="nk-tb-col">
                                                                <div class="user-card">
                                                                    <div class="user-avatar user-avatar-sm bg-warning">
                                                                        <img src="/wip/demo1/images/avatar/c-sm.jpg" alt="">
                                                                    </div>
                                                                    <div class="user-name">
                                                        ...
                                                        <tr class="nk-tb-item">
                                                            ...
                                                            <td class="nk-tb-col">
                                                                <div class="user-card">
                                                                    <div class="user-avatar user-avatar-sm bg-purple">
                                                                        <img src="/wip/demo1/images/avatar/d-sm.jpg" alt="">
                                                                    </div>
                                                                    <div class="user-name">
                        ...
                        <div class="row g-gs">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <select class="form-select form-control" id="add-account" data-search="on">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <button data-dismiss="modal" type="submit" class="btn btn-primary">Add Deposit</button>
                                </div>
                            </div>
                        </div>
                    </form>
                        ...
                        <div class="row g-gs">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <select class="form-select form-control" id="account">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <button data-dismiss="modal" type="submit" class="btn btn-primary">Update Deposit</button>
                                </div>
                            </div>
                        </div>
                    </form>
