                                                ...
                                                <table class="nk-tb-list nk-tb-ulist">
                                                    ...
                                                    <tbody>
                                                        <tr class="nk-tb-item">
                                                            ...
                                                            <td class="nk-tb-col tb-col-sm">
                                                                <span class="badge badge-dim badge-outline-success">Send</span>
                                                            </td>
                                                                ...
                                                                <ul class="nk-tb-actions gx-1">
                                                                    <li>
                                                                        <div class="drodown">
                                                                            ...
                                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                                <ul class="link-list-opt no-bdr">
                                                                                    <li><a href="#" data-toggle="modal" data-target="#edit-TReport"><em class="icon ni ni-edit"></em><span>Edit </span></a></li>
                                                        ...
                                                        <tr class="nk-tb-item">
                                                            ...
                                                            <td class="nk-tb-col tb-col-sm">
                                                                <span class="badge badge-dim badge-outline-danger">Not Send</span>
                                                            </td>
                                                            <td class="nk-tb-col nk-tb-col-tools">
                                                                <ul class="nk-tb-actions gx-1">
                                                                    <li>
