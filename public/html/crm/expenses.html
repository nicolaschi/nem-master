                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <div class="user-card">
                                                                ...
                                                                <div class="user-name">
                                                                    <span class="tb-lead">Abu Bin Ishtiyak<span class="dot dot-success d-sm-none ml-1"></span></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-lg">
                                                                    ...
                                                                    <div class="drodown">
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-right">
                                                                            <ul class="link-list-opt no-bdr">
                                                                                ...
                                                                                <li><a href="#" data-toggle="modal" data-target="#editExpenses"><em class="icon ni ni-edit"></em><span>Edit</span></a></li>
                                                                                <li><a href="#" data-toggle="modal" data-target="#deleteExpense"><em class="icon ni ni-delete"></em><span>Delete</span></a></li>
                                                                            </ul>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <div class="user-card">
                                                                ...
                                                                <div class="user-name">
                                                                    <span class="tb-lead">Barry Wayne<span class="dot dot-info d-sm-none ml-1"></span></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-lg">
                                                        ...
                                                        <div class="nk-tb-col tb-col-sm">
                                                            <span class="tb-status text-info badge badge-dot">Billable</span>
                                                        </div>
                                                        <div class="nk-tb-col nk-tb-col-tools">
                                                            <ul class="nk-tb-actions gx-2">
                                                                <li>
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <div class="user-card">
                                                                ...
                                                                <div class="user-name">
                                                                    <span class="tb-lead">Fuad Hossain<span class="dot dot-warning d-sm-none ml-1"></span></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-lg">
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <div class="user-card">
                                                                ...
                                                                <div class="user-name">
                                                                    <span class="tb-lead">Athan Travis<span class="dot dot-success d-sm-none ml-1"></span></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-lg">
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <div class="user-card">
                                                                ...
                                                                <div class="user-name">
                                                                    <span class="tb-lead">Konsta Peura<span class="dot dot-info d-sm-none ml-1"></span></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-lg">
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <div class="user-card">
                                                                ...
                                                                <div class="user-name">
                                                                    <span class="tb-lead">Wyatt Morris<span class="dot dot-success d-sm-none ml-1"></span></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-lg">
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <div class="user-card">
                                                                ...
                                                                <div class="user-name">
                                                                    <span class="tb-lead">Amilia Luna<span class="dot dot-warning d-sm-none ml-1"></span></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-lg">
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <div class="user-card">
                                                                ...
                                                                <div class="user-name">
                                                                    <span class="tb-lead">Anne Mcfadden<span class="dot dot-success d-sm-none ml-1"></span></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-lg">
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <div class="user-card">
                                                                ...
                                                                <div class="user-name">
                                                                    <span class="tb-lead">Eliana Stout<span class="dot dot-success d-sm-none ml-1"></span></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-lg">
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <div class="user-card">
                                                                ...
                                                                <div class="user-name">
                                                                    <span class="tb-lead">Aatu Juntunen<span class="dot dot-success d-sm-none ml-1"></span></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-lg">
                        ...
                        <div class="row g-gs">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <select class="form-select" id="ex-project">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <select class="form-select" id="ex-client">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <button type="submit" data-dismiss="modal" class="btn btn-primary">Update Expense</button>
                                </div>
                            </div>
                        </div>
                    </form>
