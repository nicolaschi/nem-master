                                                ...
                                                <table class="nk-tb-list nk-tb-ulist">
                                                    ...
                                                    <tbody>
                                                                ...
                                                                <ul class="nk-tb-actions gx-1">
                                                                    <li>
                                                                        <div class="drodown">
                                                                            ...
                                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                                <ul class="link-list-opt no-bdr">
                                                                                    <li><a href="#" data-toggle="modal" data-target="#restoreTask" class="eg-toastr-top-center"><em class="icon ni ni-unarchive"></em><span>Restore Task</span></a></li>
                                                                                    <li><a href="#" data-toggle="modal" data-target="#taskDelete" class="eg-toastr-error"><em class="icon ni ni-delete"></em><span>Delete Task</span></a></li>
                                                                                </ul>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                        ...
                                                        <tr class="nk-tb-item">
                                                            ...
                                                            <td class="nk-tb-col tb-col-md">
                                                                <ul class="d-flex flex-wrap g-1">
                                                                    <li><span class="badge badge-dim badge-danger">Web</span></li>
                                                                    <li><span class="badge badge-dim badge-primary">Design</span></li>
