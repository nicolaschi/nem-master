...
<head>
    ...
    <link rel="stylesheet" href="./assets/css/libs/jstree.css?ver=2.9.1">
</head>
...
&lt;/div&gt;
    ...
    <script src="./assets/js/libs/jstree.js?ver=2.9.1"></script>
    <script src="./assets/js/example-tree.js?ver=2.9.1"></script>
</body>
