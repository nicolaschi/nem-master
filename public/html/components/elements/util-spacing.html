                                        ...
                                        <div class="card card-bordered card-preview">
                                            <table class="table preview-reference">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td><code>.ml-{size}</code><br><code>.mr-{size}</code><br><code>.mt-{size}</code><br><code>.mb-{size}</code></td>
                                                        <td>0 | 1 | 2 | 3 | 4 | 5 | gs | auto</td>
                                                    ...
                                                    <tr>
                                                        <td><code>.ml-{screen}-{size}</code><br><code>.mr-{screen}-{size}</code><br><code>.mt-{screen}-{size}</code><br><code>.mb-{screen}-{size}</code></td>
                                                        <td>0 | 1 | 2 | 3 | 4 | 5 | gs | auto</td>
                                        ...
                                        <div class="card card-bordered card-preview">
                                            <table class="table preview-reference">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td><code>.pl-{size}</code><br><code>.pr-{size}</code><br><code>.pt-{size}</code><br><code>.pb-{size}</code></td>
                                                        <td>0 | 1 | 2 | 3 | 4 | 5 | gs | auto</td>
                                                    ...
                                                    <tr>
                                                        <td><code>.pl-{screen}-{size}</code><br><code>.pr-{screen}-{size}</code><br><code>.pt-{screen}-{size}</code><br><code>.pb-{screen}-{size}</code></td>
                                                        <td>0 | 1 | 2 | 3 | 4 | 5 | gs | auto</td>
                                                        <td class="text-soft">Same as above</td>
                                                    </tr>
                                                    <tr>
