                                    ...
                                    <div class="nk-block nk-block-lg">
                                        ...
                                        <div class="card card-preview">
                                            <div class="card-inner">
                                                <button type="button" class="btn btn-lg btn-primary" data-toggle="popover" title="Popover title" data-content="And here's some amazing content. It's very engaging. Right?"><span>Click to toggle popover</span></button>
                                            </div>
                                        </div><!-- .card-preview -->
...
&lt;/button&gt;
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                ...
                                                <p>Use <code>data-placement</code> value: <code>top, right, bottom</code>, and <code>left</code> direction.</p>
                                            </div>
                                        </div>
                                        <div class="card card-preview">
                                            <div class="card-inner">
                                                <ul class="preview-list">
                                                    <li class="preview-item">
                                                        <button type="button" class="btn btn-primary" data-container="body" data-toggle="popover" data-placement="top" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus."><span>Popover on top</span></button>
                                                    </li>
                                                    <li class="preview-item">
                                                        <button type="button" class="btn btn-primary" data-container="body" data-toggle="popover" data-placement="right" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus."><span>Popover on right</span></button>
                                                    </li>
                                                    <li class="preview-item">
        ...
        sagittis lacus vel augue laoreet rutrum faucibus."><span>Popover on bottom</span></button>
                                                    ...
                                                    <li class="preview-item">
                                                        <button type="button" class="btn btn-primary" data-container="body" data-toggle="popover" data-placement="left" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus."><span>Popover on left</span></button>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div><!-- .card-preview -->
...
&lt;/button&gt;
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        ...
                                        <div class="card card-preview">
                                            <div class="card-inner">
                                                <button tabindex="0" class="btn btn-danger btn-dim" data-toggle="popover" data-trigger="focus" title="Dismissible popover" data-content="And here's some amazing content. It's very engaging. Right?"><span>Dismissible popover</span></button>
                                            </div>
                                        </div><!-- .card-preview -->
                                        <div class="code-block code-block-clean">
                                            <span class="title">Uses Example</span>
                                            <pre class="prettyprint lang-html">
&lt;button tabindex=&quot;0&quot; class=&quot;btn btn-danger btn-dim&quot; data-toggle=&quot;popover&quot; 
