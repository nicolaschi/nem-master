                                        ...
                                        <div class="card card-preview">
                                            <div class="card-inner">
                                                ...
                                                <ul class="preview-list">
                                                    ...
                                                    <li class="preview-item">
                                                        <span class="badge badge-pill badge-outline-gray">Gray</span>
                                                    </li>
                                                    <li class="preview-item">
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        ...
                                        <div class="card card-preview">
                                            <div class="card-inner">
                                                <ul class="preview-list">
                                                    <li class="preview-item">
                                                        <span class="badge badge-dot badge-primary"><span>Primary</span></span>
                                                    </li>
                                                    <li class="preview-item">
                                                    ...
                                                    <li class="preview-item">
                                                        <span class="badge badge-dot badge-gray">Gray</span>
                                                    </li>
                                                    <li class="preview-item">
                                        ...
                                        <div class="card card-preview">
                                            <div class="card-inner">
                                                ...
                                                <ul class="preview-list">
                                                    ...
                                                    <li class="preview-item">
                                                        <span class="badge badge-dim badge-secondary">Secondary</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-dim badge-success">Success</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-dim badge-danger">Danger</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-dim badge-warning">Warning</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-dim badge-info">Info</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-dim badge-dark">Dark</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-dim badge-gray">Gray</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-dim badge-light">Light</span>
                                                    </li>
                                                </ul>
                                                <span class="preview-title overline-title mt-4">Pale Pill Style</span>
                                                <ul class="preview-list">
                                                    <li class="preview-item">
                                                        <span class="badge badge-pill badge-dim badge-primary">Primary</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-pill badge-dim badge-secondary">Secondary</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-pill badge-dim badge-success">Success</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-pill badge-dim badge-danger">Danger</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-pill badge-dim badge-warning">Warning</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-pill badge-dim badge-info">Info</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-pill badge-dim badge-dark">Dark</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-pill badge-dim badge-gray">Gray</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-pill badge-dim badge-light">Light</span>
                                                    </li>
                                                </ul>
                                                ...
                                                <ul class="preview-list">
                                                    ...
                                                    <li class="preview-item">
                                                        <span class="badge badge-dim badge-outline-secondary">Secondary</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-dim badge-outline-success">Success</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-dim badge-outline-danger">Danger</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-dim badge-outline-warning">Warning</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-dim badge-outline-info">Info</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-dim badge-outline-dark">Dark</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-dim badge-outline-gray">Gray</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-dim badge-outline-light">Light</span>
                                                    </li>
                                                </ul>
                                                <span class="preview-title overline-title mt-4">Pale Bordered Pill Style</span>
                                                <ul class="preview-list">
                                                    <li class="preview-item">
                                                        <span class="badge badge-pill badge-dim badge-outline-primary">Primary</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-pill badge-dim badge-outline-secondary">Secondary</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-pill badge-dim badge-outline-success">Success</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-pill badge-dim badge-outline-danger">Danger</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-pill badge-dim badge-outline-warning">Warning</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-pill badge-dim badge-outline-info">Info</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-pill badge-dim badge-outline-dark">Dark</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-pill badge-dim badge-outline-gray">Gray</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-pill badge-dim badge-outline-light">Light</span>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div><!-- .card-preview -->
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        ...
                                        <div class="card card-preview">
                                            <div class="card-inner">
                                                ...
                                                <ul class="preview-list">
                                                    <li class="preview-item">
                                                        <span class="badge badge-pill badge-xl badge-primary">Primary</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-pill badge-lg badge-primary">Primary</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-pill badge-md badge-primary">Primary</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-pill badge-sm badge-primary">Primary</span>
                                                    </li>
                                                    <li class="preview-item">
                                                        <span class="badge badge-pill badge-primary">Primary</span>
                                                    </li>
