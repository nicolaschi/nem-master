                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                ...
                                                <p>Wrap any embed like an <code>&lt;iframe&gt;</code> in a parent element with <code>.embed-responsive</code> and an aspect ratio. <br>The <code>.embed-responsive-item</code> isn’t strictly required, but we encourage it.</p>
                                            </div>
                                        </div>
                                        <div class="card card-preview">
                                            <div class="card-inner">
                                                <div class="embed-responsive embed-responsive-16by9">
                                                    <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/SSo_EIwHSd4" allowfullscreen></iframe>
                                                </div>
                                            </div>
                                        </div><!-- .card-preview -->
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        ...
                                        <div class="card card-bordered card-preview">
                                            <table class="table preview-reference">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td><code>.embed-responsive-{value}</code></td>
