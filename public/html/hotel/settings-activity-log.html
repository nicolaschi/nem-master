                                                    ...
                                                    <table class="table table-ulogs">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td class="tb-col-time"><span class="sub-text"><span class="badge badge-danger ml-0">Deleted</span></span></td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="tb-col-time"><span class="sub-text">11:34 PM</span></td>
                                                                <td class="tb-col-time"><span class="sub-text"><span class="badge badge-success ml-0">Updated</span></span></td>
                                                                <td class="tb-col-action"><a href="#" class="link-cross mr-sm-n1"><em class="icon ni ni-cross"></em></a></td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="tb-col-ip"><span class="sub-text">192.149.122.128</span></td>
                                                                <td class="tb-col-time"><span class="sub-text">11:34 PM</span></td>
                                                                <td class="tb-col-time"><span class="sub-text"><span class="badge badge-primary ml-0">Created</span></span></td>
                                                                <td class="tb-col-action"><a href="#" class="link-cross mr-sm-n1"><em class="icon ni ni-cross"></em></a></td>
                                                            </tr>
                                                            <tr>
                                                                <td class="tb-col-os">Mozilla on Window</td>
